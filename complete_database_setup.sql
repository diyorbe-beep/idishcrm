...
-- 11. Storage RLS policies'ni o'chirish va qayta yaratish
...
-- 12. Yangi Storage policies yaratish
CREATE POLICY "Allow public read access for product images" ON storage.objects
...
-- 13. Categories RLS policies (ixtiyoriy)
...
-- 14. Qo'shimcha demo ma'lumotlar
INSERT INTO products (name, category, brand, price, cost_price, selling_price, discount, quantity, min_quantity, barcode, description) 
...
-- 20. Demo xarid buyurtma elementlari
